...
namespace LFDeliveryAPP_WebApi.Class
{
    public class Cio
    {
        ...
        public List<GroupPermissionTemplate> PermissionTemplates { get; set; }
        ...
        public List<OACT> AcctCodeList{ get; set; }
        ...
        public int QueryPickIdNo { get; set; }
        public string QueryGuid { get; set; }
        public string QueryDriver { get; set; }
        public string QueryTruck { get; set; }
        public string QueryDriverName { get; set; }
        public DateTime QueryStartTime { get; set; }
        public DateTime QueryEndTime { get; set; }
        public string QueryCardCode { get; set; }
        public string QueryStatus { get; set; }

        public SummaryReportModel summaryReport { get; set; }
